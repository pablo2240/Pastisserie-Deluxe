        ...
        <div className="flex h-screen bg-gray-50 font-sans overflow-hidden">
            ...
            `}>
                ...
                <nav className="flex-1 px-4 space-y-2 overflow-y-auto custom-scrollbar pt-4">
                    ...
                    <Link to="/admin/reportes" onClick={() => setIsSidebarOpen(false)} className={`flex items-center gap-4 px-5 py-4 rounded-[1.25rem] transition-all font-black text-sm uppercase tracking-wider ${isActive('/admin/reportes')}`}>
                        <FileText size={20} strokeWidth={2.5} /> Reportes
                    </Link>
                </nav>
