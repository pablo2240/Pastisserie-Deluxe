...
namespace PastisserieAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260327161110_AddCamposDomiciliarioReclamacion")]
    partial class AddCamposDomiciliarioReclamacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PastisserieAPI.Core.Entities.ConfiguracionTienda", b =>
                {
                    ...
                    b.Property<string>("CostosEnvioPorComuna")
                        .HasMaxLength(1000)
                    ...
                    b.Property<bool>("LimitarUnidadesPorProducto")
                        .HasColumnType("bit");

                    b.Property<int>("MaxUnidadesPorProducto")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PastisserieAPI.Core.Entities.Reclamacion", b =>
                {
                    ...
                    b.Property<string>("MotivoDomiciliario")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("NombreDomiciliario")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("PastisserieAPI.Core.Entities.RegistroPago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PastisserieAPI.Core.Entities.CarritoItem", b =>
                {
                    ...
                    b.HasOne("PastisserieAPI.Core.Entities.Promocion", "Promocion")
                        .WithMany()
            ...
            modelBuilder.Entity("PastisserieAPI.Core.Entities.Reclamacion", b =>
                {
                    b.HasOne("PastisserieAPI.Core.Entities.User", "Domiciliario")
                        .WithMany()
