...
import {
  ...
  Truck, AlertCircle, Settings, Trash2
} from 'lucide-react';
          ...
          <table className="w-full text-left text-sm text-gray-600">
            <thead className="bg-[#fcfcfc] border-b border-gray-50">
              <tr>
                ...
                <th className="px-8 py-6 text-center text-[10px] font-black uppercase tracking-widest text-gray-400">Eliminar</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                ...
                <tr><td colSpan={8} className="text-center py-10 text-gray-400">No hay pedidos aquí.</td></tr>
              ) : (
                  ...
                  <>
                    <tr key={pedido.id} className={`hover:bg-[#5D1919]/[0.02] transition-all group ${expandedRow === pedido.id ? 'bg-[#5D1919]/[0.01]' : ''}`}>
                      ...
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-2 text-gray-500 font-medium">
                          ...
                          {formatMedellinDate(pedido.fechaPedido, { day: '2-digit', month: 'short', year: 'numeric' })}
                        </div>
                      </td>
                      <td className="px-8 py-5">
                    ...
                    {expandedRow === pedido.id && (
                      <tr className="bg-white group">
                        <td colSpan={8} className="px-10 py-8 border-b border-gray-50 bg-[#fcfcfc]/80 backdrop-blur-sm">
