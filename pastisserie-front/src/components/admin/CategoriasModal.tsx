...
const CategoriasModal: React.FC<CategoriasModalProps> = ({ onClose, onChange }) => {
    ...
    return createPortal(
        <div role="dialog" className="fixed inset-0 bg-[#5D1919]/20 flex items-center justify-center z-[1000] p-4 backdrop-blur-md animate-fade-in">
            <div className="bg-white rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.3)] w-[95vw] md:w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] md:max-h-[85vh] border border-[#5D1919]/10">
                ...
                <div className="p-6 md:p-10 overflow-y-auto flex-1 bg-[#fcfcfc] custom-scrollbar">
                    {/* Input Crear */}
                    <div className="mb-10">
                ...
                <div className="px-6 md:px-10 py-6 bg-gray-50 border-t border-gray-100 flex justify-center shrink-0">
                    <button
                        onClick={onClose}
