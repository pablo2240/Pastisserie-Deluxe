...
namespace PastisserieAPI.Core.Entities
{
    public class ConfiguracionTienda
    {
        ...
        /// <summary>Cantidad máxima de unidades permitidas por producto en un pedido.</summary>
        public int MaxUnidadesPorProducto { get; set; } = 10;

        /// <summary>Si true, se aplica el límite de MaxUnidadesPorProducto en el carrito.</summary>
        public bool LimitarUnidadesPorProducto { get; set; } = false;
